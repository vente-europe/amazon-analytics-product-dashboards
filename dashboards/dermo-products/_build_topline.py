...
/* Executive summary block — 3 kolumny insight cardów */
.summary{{background:#fff;border-radius:8px;padding:18px 22px;box-shadow:0 1px 3px rgba(0,0,0,.07);margin-bottom:24px;border-left:4px solid #0f2942}}
.summary h2{{font-size:.85rem;font-weight:700;color:#0f2942;text-transform:uppercase;letter-spacing:.06em;margin-bottom:14px;display:flex;align-items:center;gap:8px}}
.summary h2::before{{content:'';display:inline-block;width:22px;height:2px;background:#0f2942}}
...
/* Keywords block */
.kw-block{{background:#fff;border-radius:8px;padding:18px 22px;box-shadow:0 1px 3px rgba(0,0,0,.07);margin-bottom:24px;border-left:4px solid #16a34a}}
.kw-block h2{{font-size:.85rem;font-weight:700;color:#0f2942;text-transform:uppercase;letter-spacing:.06em;margin-bottom:6px;display:flex;align-items:center;gap:8px}}
.kw-block h2::before{{content:'';display:inline-block;width:22px;height:2px;background:#16a34a}}
.kw-block .kw-intro{{font-size:.78rem;color:#475569;line-height:1.5;margin-bottom:14px}}
...
<div class="main">
  ...
  <div class="summary">
    <h2>Podsumowanie — kluczowe wnioski (12M)</h2>
  ...
  <div class="kw-block">
    <h2>Słowa kluczowe użyte w analizie</h2>
